...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      toast.success('👋 Welcome back to TapOnn!')
    } else {
            ...
            <div className="text-center">
              ...
              <div className="space-y-2 mb-3">
                <div className="text-xs text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20 rounded px-2 py-1">
                  <strong>👑 TapOnn Admin:</strong> <code>admin@taponn.com</code> / <code>password</code>
                  <br />
                ...
                <div className="text-xs text-blue-500 dark:text-blue-400 bg-blue-100 dark:bg-blue-800 rounded px-2 py-1">
                  <strong>👤 Regular User:</strong> <code>user@example.com</code> / <code>password</code>
                  <br />
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                💡 Any email with "admin" or "taponn" gets admin access
              </p>
            </div>
          </motion.div>
        </div>
